...
export const TreeBubble: FC = () => {
    ...
    return (
        <div>
            <div className="mint-details">
                ...
                {lastMintedNft && (
                    <div style={{
                        ...
                        <a
                            href={`https://solscan.io/token/${lastMintedNft.id}?cluster=devnet`}
                            target="_blank"
            ...
            <div>
                <div>
                    <button onClick={createMerkleTree} id="otherBtns" >Create MerkleTree</button>
                    <div id='response'>
                        {_response}
                    </div>
                ...
                <div>
                    <button onClick={createCollection} id="otherBtns">Create Collection</button>
                    <div id="coloumn">

                        <div id='response'>
                            <div>
                                {_response2 && (
                                    <>Click the below link and get the token address from solscan and put it into the env file</>
                                )}
                            </div>
                            ...
                            <div>
                                {_response2 && (
                                    (() => {
                                        const cleanedResponse = _response2.replace(/"/g, '');
                                        return (
                                            <a
                                                href={`https://solscan.io/token/${cleanedResponse}?cluster=devnet`}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            >
                                                {cleanedResponse}
                ...
                <div><button onClick={mintToCollection} id="otherBtns" >Mint To Collection</button></div>
                <div id='response'>
